      ...
      <div className="kb-content-container">
        ...
        <div className="kb-author-section">
          ...
          <div className="kb-action-buttons">
            <button onClick={()=>{editArticle(article.id)}} className="kb-edit-button">
              Modifier l'article ✎
            </button>
            <button onClick={()=>{deleteArticle(article.id)}} className="kb-delete-button">
              Supprimer l'article 🗑
            </button>
          </div>
        </div>
